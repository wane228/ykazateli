...
public:
    ...
    virtual bool check(string pathtofile)= 0;
    virtual void check2(string pathtofile) = 0;
};
...
public:
    ...
    bool check(string pathtofile) override
    {
        bool enable = 0;
    ...
    void check2(string pathtofile) override
    {
        ifstream file(pathtofile);
        if (file.is_open())
        {
