...
bool longnum::checkfomistake()
{
	...
	{
		cout << "Your number cannot start from zero!!";
		return false;
	}
	while (usernum[i] != '\0')
	{
...
int main()
{
	...
	for (;;)
	{
		...
		cin >> y;
		z = x + y;
		cout << "Summ result: " << z << endl;
		z = x - y;
		cout << "Diff result: " << z << endl;
		z = x * y;
		cout << "Mult result: " << z << endl;
		z = x / y;
		cout << "Div result: " << z << endl;
		x.get_time(x, y);
		_getche();
		system("cls");
	}
